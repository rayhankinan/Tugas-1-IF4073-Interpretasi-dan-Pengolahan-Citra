classdef HistogramEqualizationController < components.HistogramEqualizationComponent
    ...
    methods
        function obj = HistogramEqualizationController(model, namedArgs)
            % CONTROLLER Controller constructor.
            
            arguments
                model(1, 1) models.HistogramEqualizationModel
                namedArgs.?controllers.HistogramEqualizationController
            end % arguments
            
            % Call the superclass constructor.
            obj@components.HistogramEqualizationComponent(model);
    ...
    methods (Access = private)
        ...
        function onExecuteButtonPushed(obj, ~, ~)
            ...
            imageData = wrapper.GetHistogramEqualizedImage();
