classdef HistogramEqualizationView < components.HistogramEqualizationComponent
    ...
    methods
        function obj = HistogramEqualizationView(model, namedArgs)
            %VIEW Construct a view object.
            
            arguments
                model(1, 1) models.HistogramEqualizationModel
                namedArgs.?views.HistogramEqualizationView
            end
