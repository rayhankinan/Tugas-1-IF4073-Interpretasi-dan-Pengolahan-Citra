classdef HistogramStretchingView < components.HistogramStretchingComponent
    ...
    methods
        function obj = HistogramStretchingView(model, namedArgs)
            %VIEW Construct a view object.
            
            arguments
                model(1, 1) models.HistogramStretchingModel
                namedArgs.?views.HistogramStretchingView
            end
