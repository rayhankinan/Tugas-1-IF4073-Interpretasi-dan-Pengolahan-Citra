classdef PowerTransformationView < components.PowerTransformationComponent
    ...
    methods
        function obj = PowerTransformationView(model, namedArgs)
            %VIEW Construct a view object.
            
            arguments
                model(1, 1) models.PowerTransformationModel
                namedArgs.?views.PowerTransformationView
            end
